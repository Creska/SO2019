...
#ifdef DEBUG
#define SCHEDULER_TIME_SLICE            300000            // in microseconds (increased in DEBUG mode to minimize risk of interval timer interruptions while logging during process execution)
#else
